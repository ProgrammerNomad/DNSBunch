...
PHASE_BY_FILE = {
    ...
    "platform/generic-tool-bff.md": "0",
    "platform/scale-async-jobs.md": "4",
    "platform/privacy-anonymous-mode.md": "2",
    "shipped/dns-health-single.md": "-",
    "deferred/dnssec-validation.md": "1",
    "deferred/interactive-tutorial.md": "5",
    "deferred/community-forum.md": "5",
    "deferred/dns-best-practices-guide.md": "5",
