...
| [features/platform/auth-optional-accounts.md](features/platform/auth-optional-accounts.md) | Optional accounts (passwordless) | **shipped** | 2 | P1 | SavedCheck + dashboard |
...
| [features/email/mail-tester-inbound.md](features/email/mail-tester-inbound.md) | Mail tester (dev ingest + webhook) | partial | 2 | P1 | retention |
